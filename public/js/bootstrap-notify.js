...
(function(factory) {
    ...
    var defaults = {
        ...
        onClick: null,
        icon_type: 'class',
        template: '<div data-notify="container" class="col-11 col-sm-4 alert alert-{0} bg-{0} border-{0} text-white"' +
            ' role="alert"><a' +
            ' aria-hidden="true" class="close" data-notify="dismiss" href="javascript:void(0)">&times;</a><span' +
